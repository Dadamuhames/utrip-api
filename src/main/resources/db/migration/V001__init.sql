...
CREATE INDEX idx_agency_image_agency ON agency_images (agency_id);
CREATE INDEX idx_agency_video_agency ON agency_videos (agency_id);
...
CREATE INDEX idx_agency_contacts_agency ON agency_infos (agency_id);
...
CREATE TABLE tours (
    ...
    CONSTRAINT fk_region FOREIGN KEY (region_id) REFERENCES regions(id) ON DELETE RESTRICT,
    CONSTRAINT fk_agency FOREIGN KEY (agency_id) REFERENCES agencies(id) ON DELETE RESTRICT
);
